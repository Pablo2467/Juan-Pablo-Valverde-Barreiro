...
![Mockup preview](./docs/mockup.svg)
...
El wireframe de la distribución de la vista está en [`docs/mockup.svg`](./docs/mockup.svg). Muestra los tres estados que maneja la app (carga, datos, error) y cómo se distribuyen el encabezado, la grilla de tarjetas y el pie de página.
...
- Endpoint usado: `GET /character?page={n}` (paginado, 20 personajes por página).
